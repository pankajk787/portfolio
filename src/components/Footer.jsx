  ...
  <footer id="contactMe" className="bg-gray-900 sm:px-16 px-6">
    ...
    >
      <div className={` ${layout.sectionInfo}`}>
        <h2 className="text-xl font-bold text-gray-300 font-poppins dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
          {aboutMe.name}
        </h2>
        <p
        ...
        <div className="grid grid-cols-2">
          ...
          <a href={resumeLink} target="_blank">
            <Button styles="mt-10 mr-3 inline-flex items-center justify-center" text="Resume" icon={FaRegFile} />
          </a>
